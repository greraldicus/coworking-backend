...
from app.schemas import AttributesIdentifiedSchema, AttributeValueByWorkplaceId, AttributeWithValuesSchema
...
async def get_attributes_values_by_workplace_type_id_endpoint(
    ...
    return await get_attributes_values_by_wptype_id(db=db, wptype_id=wptype_id)
